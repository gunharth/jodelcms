...
<body>
	<iframe id="editorIFrame" name="editorIFrame" src="{{ $src }}?menu={{ $menu }}&lang={{ $lang }}" frameborder="0" style="position: absolute; margin: 0; padding:0; width: 100%; height: 100%;"></iframe>
